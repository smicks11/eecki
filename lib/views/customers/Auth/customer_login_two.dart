...
class CustomerLoginTwo extends StatefulWidget {
  const CustomerLoginTwo({Key key}) : super(key: key);

  @override
  State<CustomerLoginTwo> createState() => _CustomerLoginTwoState();
}

bool obserText = true;

class _CustomerLoginTwoState extends State<CustomerLoginTwo> {
  bool _loading = false;
                ...
                press: () async{
                  ...
                  await Future.value(
                    AuthService.signInWithEmailAndPwd(
                      context: context,
                      userSignInEmail: _emailController.text,
